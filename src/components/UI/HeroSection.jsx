        ...
        >        
            ...
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 lg:content-center relative">
                ...
                <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                    ...
                    <a href="https://github.com/belsua/ByteQuiz/releases/download/v1.2.0/bytequiz-1.2.0.apk" className="hidden inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center bg-white/40 backdrop-blur-sm text-white rounded-lg border border-gray-300 hover:bg-white hover:text-blue-700">
